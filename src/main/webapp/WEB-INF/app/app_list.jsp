...
<title>全部软件-Mobile Market应用商场</title>
<meta name="keywords" content="">
<meta name="description" content="">
<script>
	var _udata = _udata || [];
</script>
<link href="${pageContext.request.contextPath }/htmlresource/saved_resource" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/htmlresource/web.css">
<script type="text/javascript" src="${pageContext.request.contextPath }/htmlresource/jquery.js"></script>
...
<body>
			...
			<div class="wrapper">
				<div class="logo fl mt10">
					<a href="http://www.10086.cn/" target="_blank"><img
						src="${pageContext.request.contextPath }/htmlresource/92x36x2.png" alt="中国移动"></a><a
						href="http://mm.10086.cn/"><img
						src="${pageContext.request.contextPath }/htmlresource/163x36x1.png" alt="MM移动商场"></a><a
						href="${pageContext.request.contextPath }/cart/toCart.do" target="_blank"><img
						src="${pageContext.request.contextPath }/htmlresource/w30x36x1.png" alt="我的购物车"></a>
				</div>
				<div id="mmd_login">
					<div class="use_before fr mt5">
						<c:if test="${loginuser!=null}">
							<a class="c2290e4 fz16 lh40 ml20 mr20" href="javascript:void(0)" rel="nofollow"><img style="height: 36px;" src="${tinyurl==null?'${pageContext.request.contextPath }/htmlresource/defaultuserimg80x80.jpg':tinyurl}" />${loginuser.nickname}</a>
			...
			<div class="header-bottom">
				<div class="wrapper android">
					<ol class="pull-down-android h40 mb15" style="padding-left: 10px"
						...
						<li><a
							class="on lh40 on-down pr15 fz14 c2290e4 ml25 mr25 opacity08"
							style="_padding-left: 30px; _margin-right: 0px;"
							href="${pageContext.request.contextPath }/app/toAppList.do?cpage=1">软件</a><span
							class="c2290e4">|</span>
							<ul
								class="on-down-down hidden w120 absolute top40 left0 pt0 pb10 pl5 bgcffffff">
								<li><a
									href="${pageContext.request.contextPath }/app/toAppList.do?cpage=1"
									class="on w50 pl5 pr5 fz12 lh30 fl">全部软件</a></li>
	...
	<div id="list">
		<div class="wraper navigation-nav">
			<div class="clearfix">
				<a href="http://mm.10086.cn/android">Android频道</a><span
					style="font-size: 16px;">&gt;</span><a
					href="http://mm.10086.cn/android/software">软件</a><span
					style="font-size: 16px;">&gt;</span><a href="javascript:;">全部软件</a>
			</div>
		</div>
		<div class="wraper shadow cat-box mt5">
			<div class="cat">
				<a href="http://mm.10086.cn/android/game?pay=1" class="game ">游戏</a><a
					href="http://mm.10086.cn/android/software?pay=1"
					class="software selected">软件</a><a
					href="http://mm.10086.cn/android/theme?pay=1" class="theme ">主题</a>
			</div>
			<div class="nav clearfix mt15">
				<a href="http://mm.10086.cn/android/software/qbrj?pay=1"
					class="selected">全部软件</a><a
					href="http://mm.10086.cn/android/software/srf?pay=1">输入法</a><a
					href="http://mm.10086.cn/android/software/yygj?pay=1">影音工具</a><a
					href="http://mm.10086.cn/android/software/szyl?pay=1">数字音乐</a><a
					href="http://mm.10086.cn/android/software/wlsp?pay=1">网络视频</a><a
					href="http://mm.10086.cn/android/software/cyms?pay=1">餐饮美食</a><a
					href="http://mm.10086.cn/android/software/sqjy?pay=1">社区交友</a><a
					href="http://mm.10086.cn/android/software/llq?pay=1">浏览器</a><a
					href="http://mm.10086.cn/android/software/mhbz?pay=1">美化壁纸</a><a
					href="http://mm.10086.cn/android/software/etyy?pay=1">儿童应用</a><a
					href="http://mm.10086.cn/android/software/dzsj?pay=1">电子书籍</a><a
					href="http://mm.10086.cn/android/software/jkyl?pay=1">健康医疗</a><a
					href="http://mm.10086.cn/android/software/ktdm?pay=1">卡通动漫</a><a
					href="http://mm.10086.cn/android/software/ylbg?pay=1">娱乐八卦</a><a
					href="http://mm.10086.cn/android/software/wlgw?pay=1">网络购物</a><a
					href="http://mm.10086.cn/android/software/sylx?pay=1">摄影录像</a><a
					href="http://mm.10086.cn/android/software/aqfh?pay=1">安全防护</a><a
					href="http://mm.10086.cn/android/software/jyjx?pay=1">教育教学</a><a
					href="http://mm.10086.cn/android/software/shzs?pay=1">生活助手</a><a
					href="http://mm.10086.cn/android/software/lycx?pay=1">旅游出行</a><a
					href="http://mm.10086.cn/android/software/swbg?pay=1">商务办公</a><a
					href="http://mm.10086.cn/android/software/xtgj?pay=1">系统工具</a><a
					href="http://mm.10086.cn/android/software/thtx?pay=1">通话通信</a><a
					href="http://mm.10086.cn/android/software/bkzz?pay=1">报刊杂志</a><a
					href="http://mm.10086.cn/android/software/jtdh?pay=1">交通导航</a><a
					href="http://mm.10086.cn/android/software/jrlc?pay=1">金融理财</a><a
					href="http://mm.10086.cn/android/software/xwzx?pay=1">新闻资讯</a><a
					href="http://mm.10086.cn/android/software/ranking?pay=1">软件排行</a>
			</div>
			<div class="clear"></div>
			<div class="line-btm-d"></div>
			<div class="list-ios clearfix">
				<div class="list-ios-cndt fl">
					<span>价格：</span><a
						href="http://mm.10086.cn/android/software/qbrj?order=9"
						class="selected">不限</a><a
						href="http://mm.10086.cn/android/software/qbrj?order=9&pay=1">免费</a><a
						href="http://mm.10086.cn/android/software/qbrj?order=9&pay=2">付费</a><span
						class="ml160">排序：</span><a
						href="http://mm.10086.cn/android/software/qbrj" class="selected">默认</a><a
						href="http://mm.10086.cn/android/software/qbrj?order=1">最新</a><a
						href="http://mm.10086.cn/android/software/qbrj?order=2">评分</a>
				</div>
			</div>
		</div>
		<div class="sequence" style="width: 1016px; margin: 0px auto;">
			<ul id="container" class="masonry"
				style="position: relative; height: 1321px;">
				<c:forEach items="${applist}" var="app">
				<li class="box listitem masonry-brick"
					><div
						class="part-1">
						<div class="img">
							<i class="free"></i>
							<div class="down" style="display: none;">
								<a
									href="/filepath/html/apphtml/${app.id}.html"
									target="_blank">免费下载</a>
							</div>
							<a
								href="/filepath/html/apphtml/${app.id}.html"
								target="_blank"><img
								src="/filepath/img/${app.id}_1.jpg"
								style="width: 210px; height: 280px;" alt="QQ"></a>
						</div>
						<div class="info">
						<!-- ${fn:substring(app.appname,0,13) }${fn:length(app.appname)>13?"...":""}通过jstl标签来限制app名字长度，超出部分用省略号代替 -->
							<a href="/filepath/html/apphtml/${app.id}.html"
								title="${app.appname}" target="_blank" class="autoword"><strong>${fn:substring(app.appname,0,13) }${fn:length(app.appname)>13?"...":""}</strong></a>
							<p>
								<span>星级:</span><span class="star small stargrey-s"><span
									class="star starlight-s" style="width: 80%"></span></span>
							</p>
							<p class="h401 o-hidden" style="height: 40px;">${app.appname}</p>
							<p>
								<span style="color: #ff5a00;">${app.downloadNums}</span>感兴趣
							</p>
						</div>
					</div></li>
				</c:forEach>
		...
		<div class="wraper shadow loading" style="display: none;">
			<i></i> 正在加载...
		</div>
	</div>
	<div class="wraper">
		<div class="list-page">
			<a href="${pageContext.request.contextPath }/app/toAppList.do?cpage=0" class="first" disabled="" style="color: gray;">首页</a>
			<a href="${pageContext.request.contextPath }/app/toAppList.do?cpage=${cpage-1}" class="prev" disabled="" style="color: gray;">上一页</a>
			<a href="${pageContext.request.contextPath }/app/toAppList.do?cpage=${cpage-3}" ${cpage-3<1?"style='display:none;'":""}>&nbsp;${cpage-3}&nbsp;</a>&nbsp;
			<a href="${pageContext.request.contextPath }/app/toAppList.do?cpage=${cpage-2}" ${cpage-2<1?"style='display:none;'":""}>&nbsp;${cpage-2}&nbsp;</a>&nbsp;
			<a href="${pageContext.request.contextPath }/app/toAppList.do?cpage=${cpage-1}" ${cpage-1<1?"style='display:none;'":""}>&nbsp;${cpage-1}&nbsp;</a>&nbsp;
			&nbsp;<span class="current">${cpage}</span>&nbsp;
			<a href="${pageContext.request.contextPath }/app/toAppList.do?cpage=${cpage+1}" ${cpage+1>totalPage?"style='display:none;'":""}>&nbsp;${cpage+1}&nbsp;</a>&nbsp;
			<a href="${pageContext.request.contextPath }/app/toAppList.do?cpage=${cpage+2}" ${cpage+2>totalPage?"style='display:none;'":""}>&nbsp;${cpage+2}&nbsp;</a>&nbsp;
			<a href="${pageContext.request.contextPath }/app/toAppList.do?cpage=${cpage+3}" ${cpage+3>totalPage?"style='display:none;'":""}>&nbsp;${cpage+3}&nbsp;</a>
			<a href="${pageContext.request.contextPath }/app/toAppList.do?cpage=${cpage+1}" class="next">下一页</a>
			<a href="${pageContext.request.contextPath }/app/toAppList.do?cpage=${totalPage}" class="last">尾页</a>
		</div>
	</div>
	<div class="clear"></div>
...
#footer ol.about li a, #footer ol.about li i {
			...
			<div class="relative mmqrc_dd1121" id="mmqrc">
				...
				<div>
					...
					<div class="d_core" style="">
						<img src="${pageContext.request.contextPath }/htmlresource/108x108x11.png" height="109" width="108"
							alt="">
					</div>
					<div class="d_share"
	...
	<div id="mmLoadicon" class="jqmWindow" style="top: 47%;">
		<img src="${pageContext.request.contextPath }/htmlresource/loading_s.gif" class="jqmClose">
	</div>
	<script type="text/javascript" src="${pageContext.request.contextPath }/htmlresource/saved_resource(1)"></script>
	<script type="text/javascript">
		$url = '/android/software/qbrj?order=9&p=1';
		$screensOfPage = 4;
		$screenSize = 12;
	</script>
	<script type="text/javascript">
	...
	<script src="${pageContext.request.contextPath }/htmlresource/udata.js" type="text/javascript"></script>
</body>
</html>